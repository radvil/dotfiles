...
false\t''"
complete -c deno -n "__fish_deno_needs_command" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand run" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand serve" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand bench" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand bundle" -l unstable-node-conditions -r
...
complete -c deno -n "__fish_deno_using_subcommand bundle" -l one-file -d 'Bundle into one file' -r -f -a "true\t''
false\t''"
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand cache" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand check" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand compile" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand eval" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand install" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand i" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand repl" -l unstable-node-conditions -r
...
false\t''"
complete -c deno -n "__fish_deno_using_subcommand test" -l unstable-node-conditions -r
...
complete -c deno -n "__fish_deno_using_subcommand help; and not __fish_seen_subcommand_from run serve add remove bench bundle cache check clean compile completions coverage doc eval fmt init info install json_reference jupyter uninstall outdated lsp lint publish repl task test types upgrade vendor" -l unstable-subdomain-wildcards -d 'Enable subdomain wildcards support for the `--allow-net` flag'
