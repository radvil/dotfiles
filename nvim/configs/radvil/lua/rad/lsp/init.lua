...
-- local imap = require("rad.keymap").imap
-- local nmap = require("rad.keymap").nmap
-- local autocmd = require("rad.auto").autocmd
-- local autocmd_clear = vim.api.nvim_clear_autocmds
-- local telescope_mapper = require "rad.telescope.mappings"
-- local handlers = require "rad.lsp.handlers"

local ts_util = require("nvim-lsp-ts-utils")
local handlers = require("rad.lsp.handlers")
local inlays = require("rad.lsp.inlay")
...
local custom_attach = function(client, bufnr)
  ...
  buf_nnoremap({ "<space>lr", "<cmd>lua R('rad.lsp.codelens').run()<CR>" })
