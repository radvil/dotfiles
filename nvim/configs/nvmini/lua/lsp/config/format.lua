...
---@type PluginLspFormatOpts
M._opts = nil

local LazyUtils = require("lazy.core.util")

function M.enabled()
  return M._opts.autoformat
end

function M.toggle()
  if vim.b.autoformat == false then
    vim.b.autoformat = nil
    M._opts.autoformat = true
  else
    M._opts.autoformat = not M._opts.autoformat
  end
  if M._opts.autoformat then
...
---@param opts PluginLspFormatOpts
